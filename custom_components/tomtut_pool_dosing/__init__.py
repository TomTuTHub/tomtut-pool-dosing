...
async def _async_register_static_paths(hass: HomeAssistant) -> None:
    """Register integration static paths once per Home Assistant instance."""
    domain_data = hass.data.setdefault(DOMAIN, {})

    if domain_data.get(STATIC_REGISTRATION_KEY):
        return
...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    """Set up the integration domain and static paths."""
